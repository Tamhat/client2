        ...
        <div className="about_as">
          ...
          <div class="container">
            ...
            <div className="about-us-container">
              ...
              <p style={{margin:5}}>
                Welcome to Royalbit Exchange, where cutting-edge technology meets the world of cryptocurrency.
                At Royalbit Exchange, our mission is to provide a secure, efficient, and user-friendly platform
              ...
              <h2 style={{ textDecoration: 'underline', color: '#38a0a1', margin: 5 }}>Why Choose Royalbit Exchange?</h2>
              <ul style={{margin:5}}>
                <li>
                ...
                <li>
                  <strong>User-Friendly Interface:</strong> Royalbit Exchange is designed with simplicity in mind.
                ...
                <li>
                  ...
                  exciting world of cryptocurrency. Royalbit Exchange provides a global platform for trading a diverse
              ...
              <p style={{margin:5}}>
                Royalbit Exchange is committed to complying with all applicable laws and regulations. We work closely
              ...
              <p style={{margin:5}}>
                ...
                Royalbit Exchange is here to support your journey. Explore new opportunities, diversify your
              ...
              <p style={{margin:5}}>Welcome to Royalbit Exchange - Your Gateway to the Future of Finance!</p>
            </div>
